...
(function () {
  ...
  const FIXTURES = [
    ...
    K('m79', 'r32', 'México',             'Ecuador',              '2026-07-01T01:00:00Z', 'Ciudad de México'),
    K('m80', 'r32', 'Inglaterra',         'Congo RD',             '2026-07-01T16:00:00Z', 'Atlanta'),
    K('m81', 'r32', 'Estados Unidos',     'Bosnia y Herzegovina', '2026-07-02T00:00:00Z', 'Santa Clara'),
    ...
    K('m88', 'r32', 'Australia',          'Egipto',               '2026-07-03T18:00:00Z', 'Dallas'),
