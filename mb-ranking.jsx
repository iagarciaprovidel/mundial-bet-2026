...
(function () {
  ...
  // Medallas ACUMULABLES por nº de apuestas (junto al nombre, sin llama: la
  // llama con la cantidad va una sola vez en el subtexto "🔥 N apuestas").
  ...
  function RankingReal({ compact, limit }) {
    ...
    return (
      <div>
        {!compact && <div style={{ fontSize: 'var(--t-2xs)', color: 'var(--muted-2)', textAlign: 'center', marginBottom: 10 }}>Cada jugador parte con 90.000 puntos · 🔥 = apuestas hechas</div>}
