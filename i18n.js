...
(function () {
  ...
  var DICT_EN = {
    ...
    'Avisarme': 'Notify me', 'Siguiendo': 'Following',
    'Avisarme de este partido (inicio, goles y resultado)': 'Notify me about this match (start, goals and result)',
    'Dejar de seguir este partido': 'Stop following this match',
    '🔒 Cerrada': '🔒 Closed', '🔴 En vivo': '🔴 Live',
    'Mi álbum de figuritas': 'My sticker album', '🎴 Mi álbum 2026': '🎴 My album 2026',
    'Me faltan': 'Missing', 'Tengo': 'I have', 'Repetidas': 'Duplicates',
    'Buscar jugador o número…': 'Search player or number…',
    'No hay figuritas en este filtro.': 'No stickers in this filter.',
    'Tocar = la tengo · tocar otra vez = repetida · mantener = quitar': 'Tap = got it · tap again = duplicate · hold = remove',
    'Mi álbum 2026': 'My album 2026', '🙋 Mi álbum': '🙋 My album',
    '🔒 Bloqueado por el dueño · solo lectura': '🔒 Locked by the owner · view only', '🔒 Álbum bloqueado': '🔒 Album locked',
    '🔒 Bloqueado · toca el candado para editar': '🔒 Locked · tap the lock to edit', '🔒 Quita el candado para editar': '🔒 Remove the lock to edit',
  ...
  var DICT_PT = {
    ...
    'Avisarme': 'Avise-me', 'Siguiendo': 'Seguindo',
    'Avisarme de este partido (inicio, goles y resultado)': 'Avise-me deste jogo (início, gols e resultado)',
    'Dejar de seguir este partido': 'Deixar de seguir este jogo',
    '🔒 Cerrada': '🔒 Encerrada', '🔴 En vivo': '🔴 Ao vivo',
    'Mi álbum de figuritas': 'Meu álbum de figurinhas', '🎴 Mi álbum 2026': '🎴 Meu álbum 2026',
    'Me faltan': 'Faltam', 'Tengo': 'Tenho', 'Repetidas': 'Repetidas',
    'Buscar jugador o número…': 'Buscar jogador ou número…',
    'No hay figuritas en este filtro.': 'Não há figurinhas neste filtro.',
    'Tocar = la tengo · tocar otra vez = repetida · mantener = quitar': 'Tocar = tenho · tocar de novo = repetida · segurar = remover',
    'Mi álbum 2026': 'Meu álbum 2026', '🙋 Mi álbum': '🙋 Meu álbum',
    '🔒 Bloqueado por el dueño · solo lectura': '🔒 Bloqueado pelo dono · somente leitura', '🔒 Álbum bloqueado': '🔒 Álbum bloqueado',
    '🔒 Bloqueado · toca el candado para editar': '🔒 Bloqueado · toque o cadeado para editar', '🔒 Quita el candado para editar': '🔒 Tire o cadeado para editar',
